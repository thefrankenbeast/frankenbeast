...
describe("DeterministicGrounder", () => {
    it("PASS — response with no tool_calls is unaffected", () => {
        ...
        if (result.passed)
            expect(result.value).toBe(BASE_RESPONSE);
    });
    it("PASS — all tool call function_names exist in Skill Registry", () => {
        const response = { ...BASE_RESPONSE, tool_calls: [WEATHER_TOOL_CALL], finish_reason: "tool_use" };
...
//# sourceMappingURL=deterministic-grounder.test.js.map