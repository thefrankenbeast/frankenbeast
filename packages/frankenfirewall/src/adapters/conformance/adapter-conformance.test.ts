...
import type { ConformanceFixtures } from "./adapter-conformance.js";
...
describe("Adapter Conformance: ClaudeAdapter", () => {
  ...
  it("tool response has correct shape", () => {
    ...
    expect(unified.tool_calls[0]!.arguments).toBe(
      JSON.stringify({ location: "San Francisco, CA", unit: "celsius" }),
    );
