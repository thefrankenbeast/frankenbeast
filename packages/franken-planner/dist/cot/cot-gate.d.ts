 ...
 */
export declare function buildCoTExecutor(executor: TaskExecutor, selfCritique: SelfCritiqueModule, enforcer?: RationaleEnforcer): TaskExecutor;
//# sourceMappingURL=cot-gate.d.ts.map