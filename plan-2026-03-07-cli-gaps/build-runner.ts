#!/usr/bin/env npx tsx
/**
 * FRANKENBEAST Build Runner — plan-2026-03-07-cli-gaps
...
function showHelp(): void {
  console.log(`FRANKENBEAST Build Runner — plan-2026-03-07-cli-gaps
Usage: npx tsx plan-2026-03-07-cli-gaps/build-runner.ts [options]
Options:
